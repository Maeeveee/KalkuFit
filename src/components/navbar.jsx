export default function Navbar() {
    return (
    <nav class="bg-white border-gray-200 dark:bg-white mb-4">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <button data-collapse-toggle="navbar-default" type="button" class="inline-flex items-center p-2 w-10 h-10 bg-green-600 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-green-900 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-white dark:hover:bg-green-900 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
